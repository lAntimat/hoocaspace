...
import 'package:hoocaspace/data/usecase/reservation_use_case.dart';
...
class TobaccoPresenter {
  ...
  IReservationUseCase useCase = ReservationUseCase(Injector.provideProductDataSource());
  ...
  fetchData() async {
    ...
    await Future.wait([useCase.getReservations()])
        .then((List responses) {
      tobacco = responses[0];
